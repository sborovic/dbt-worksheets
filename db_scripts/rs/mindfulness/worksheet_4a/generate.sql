CREATE TABLE mindfulness_worksheet_4a (id INTEGER PRIMARY KEY, parent_id INTEGER, title TEXT, description TEXT, is_leaf INTEGER DEFAULT 0, is_deleted INTEGER DEFAULT 0);
...
("Proširite svesnost: Na celo telo, prostor oko sebe, grleći drvo.", 1, 10),
("Otvorite um: Svakoj senzaciji koja se pojavi, bez vezivanja, puštajući ih.", 1, 11),
("Vežbanje opisivanja", 0, 12),
("Šta vidite van svoga tela.", 12, 13),
("Misli, osećanja i telesne senzacije u vama.", 12, 14),
("Vaše disanje.", 12, 15),
("Vežbanje učestvovanja", 0, 16),
...
("Iskočite iz kreveta i plešite, ili pevajte pre nego što se obučete.", 16, 21),
